setwd("~/Google Drive/Hurwitz Lab/Postdocking/infant_gut")

#### Doc string ####
# copied from github:/hurwitzlab/fizkin/scripts/sna.r
...
matrix_file  = "distance.matrix"
out_dir      = getwd()
n_iter       = 1000
alias_file   = ""
sna_filename = "sna-gbme.pdf"
...
paste("Using GBME_OUT",GBME_OUT,collapse ="\n")
